...
function initializeApp() {
    ...
    // Social Media Links
    const socialLinks = {
        instagram: 'https://www.instagram.com/pksss.shaurya?igsh=eGUxbzJ4ZTFxZzg2',
        facebook: 'https://facebook.com/mmpublicschool',
        youtube: 'https://youtube.com/@pksss8084?si=qco2It311-T3rVMN',
        whatsapp: ''
    };
        ...
        resultCard.innerHTML = `
            ...
            ${failSubjects.length > 0 ? `
                <div class="fail-subjects">
                    <h3><i class="fas fa-exclamation-triangle"></i> Subjects Requiring Improvement</h3>
                    <ul class="fail-list">
            ...
            <div class="result-summary">
                <div class="summary-item">
                    <h4>📈 Percentage</h4>
                    <div class="summary-value percentage-value">${percentage}%</div>
                </div>
                <div class="summary-item">
                    <h4>⭐ Grade</h4>
                    <div class="summary-value grade-value">${grade}</div>
                </div>
                <div class="summary-item">
                    <h4>🏆 Division</h4>
    ...
    function createSubjectHTML(subjectName, marks) {
        ...
        const isFail = marksInt < 30;
        const isPerfect = marksInt === 100;
        const iconClass = getSubjectIcon(subjectName);
        
        return `
            <div class="subject-container">
                <div class="subject-row ${isFail ? 'fail' : ''} ${isPerfect ? 'perfect' : ''}">
    ...
    function calculateStatus(percentage) {
        ...
        return { text: '❌ FAIL', class: 'fail-status-overall' };
    }
    ...
    removeAllDataBtn.addEventListener('click', async function() {
        ...
        confirmationModal.innerHTML = `
            <div class="modal-content" style="max-width: 450px;">
                <div style="text-align: center; padding: 30px;">
                    <i class="fas fa-exclamation-triangle" style="font-size: 5rem; color: #e17055; margin-bottom: 25px; animation: pulse 2s infinite;"></i>
                    <h2 style="color: #e17055; margin-bottom: 20px; font-size: 2rem;">⚠️ Confirm Delete</h2>
                    <p style="font-size: 1.2rem; margin-bottom: 30px; line-height: 1.6;">
                        Are you sure you want to delete <strong style="color: #e17055;">ALL</strong> student results?<br>
                        <span style="color: #e17055; font-weight: 700;">This action cannot be undone!</span>
                    </p>
        ...
        document.getElementById('confirmDelete').addEventListener('click', async function() {
            ...
            try {
                ...
                showToast('🗑️ All student results have been deleted successfully');
            } catch (error) {
